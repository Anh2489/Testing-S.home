...
- Quản lý kho.
- Quản lý voucher và các chức năng khuyến mãi.
- Quản lý bộ sưu tập.
...
- Mục đích của từng chức năng.
- Cách người dùng thao tác trên hệ thống.
- Luồng xử lý chính.
...
- Xác định được các chức năng cần ưu tiên tìm hiểu.
- Có cơ sở để tiếp tục nghiên cứu tài liệu SRS và xây dựng kế hoạch
  kiểm thử.
